...
class Attendace:
    def __init__(self,root):
        ...
        # Images
        img10 = Image.open("college_images/face7.jpeg")
        ...
        img11 = Image.open("college_images/face77.jpeg")
        ...
        img1 = Image.open("college_images/back.jpg")
        ...
        title=Label(self.root,text="STUDENT ATTENDANCE",font=("times new roman",35,"bold"),bg="white",fg="navy blue")
        title.place(x=0,y=170,width=1550,height=45)
        ...
        img30 = Image.open("college_images/face10.png")
        ...
        btnAddData=Button(ButtonFrame1,text="Import csv",command=self.importData,font=("arial",11,"bold"),width=16,bg="navy blue",fg="white")
        btnAddData.grid(row=0,column=0,padx=1)

        btnUpdate=Button(ButtonFrame1,text="Export csv",command=self.export_data,font=("arial",11,"bold"),width=16,bg="navy blue",fg="white")
        btnUpdate.grid(row=0,column=1,padx=1)

        btnDelete=Button(ButtonFrame1,text="Update",command=self.action,font=("arial",11,"bold"),width=16,bg="navy blue",fg="white")
        btnDelete.grid(row=0,column=2,padx=1)

        btnReset=Button(ButtonFrame1,text="Reset",command=self.clear,font=("arial",11,"bold"),width=16,bg="navy blue",fg="white")
        ...
        btnback=Button(title,text="Back",command=self.go_back,font=("arial",11,"bold"),width=17,bg="white",fg="navy blue")
    ...
    def fetch_data(self):
        conn=mysql.connector.connect(host="localhost",username="root",password="Rani#2450Tom",database="facial_recognition")
